...
# curl -i --header "Accept: application/vnd.github.v3.diff" https://api.github.com/repos/danleyb2/deep-license-plate-recognition/pulls/29


def send_to_openai(prompt, key, model="gpt-4-1106-preview"):
    """
